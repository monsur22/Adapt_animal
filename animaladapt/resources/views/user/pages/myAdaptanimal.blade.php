                        ...
                        <tbody>
                            ...
                            @endforeach --}}
                                ...
                                <td>
                                    ...
                                    {{-- @if($datas->status==1)
                                    <a href="{{route('mypost_status_update',['id'=>$datas->id])}}" class="btn btn-success" title=" Confirm">
                                        <span class="fa fa-arrow-up"></span>
                                    </a>
                                    @elseif($datas->branch_status==0)
                                    <a href="{{route('mypost_status_update',['id'=>$datas->id])}}" class="btn btn-danger" title="Not Confirm">
