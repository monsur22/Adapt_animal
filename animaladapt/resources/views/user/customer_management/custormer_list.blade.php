...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <form method="POST" action="{{ url('/customerlist') }}">
            {{csrf_field()}}
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ url('/customerlist/update') }}">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <tbody>
                            ...
                            <td>{{$customer->copaning_balance}}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{  url('/customer/delete/'.$customer->id) }}" class="btn btn-danger" title="Delete"onclick="return confirm('Are you sure to delete this?')">
